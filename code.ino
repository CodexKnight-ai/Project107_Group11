...
const bool brailleMap[16][6] = {
  ...
  {1, 0, 1, 0, 0, 0}, // A (Dots 1, 3)
  {1, 1, 1, 0, 0, 0}, // B (Dots 1, 2, 3)
  {1, 0, 1, 1, 0, 0}, // C (Dots 1, 3, 4)
  {1, 0, 1, 1, 1, 0}, // D (Dots 1, 3, 4, 5)
  {1, 0, 1, 0, 1, 0}, // E (Dots 1, 3, 5)
  {0, 0, 0, 0, 0, 0}  // Custom for # (all LEDs OFF)
};
